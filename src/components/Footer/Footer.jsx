...
function Footer() {
  return (
    <footer className="footer">
      ...
      <a href="https://www.nastavniki.org/campaign/pomoch-dengami" class="button footer__button" rel="noreferrer" target="_blank">Помочь деньгами</a>
      <div class="footer__column footer__column_content_concept">
        ...
        <a href="https://praktikum.yandex.ru/" class="footer__production" rel="noreferrer" target="_blank">Яндекс.Практикум</a>
          </p>
          <p class="footer__design">Концепция и дизайн –
        <a href="https://krkr.design/" class="footer__production" rel="noreferrer" target="_blank">krkr.design</a>
          </p>
        </div>
      </div>
        ...
        <ul class="footer__column-list">
          ...
          <li class="footer__column-links">
            <a href="https://vk.com/big.brothers.big.sisters"
              ...
              target="_blank"
              rel="noreferrer">vkontakte
            </a>
          </li>
          <li class="footer__column-links">
            <a href="https://www.instagram.com/nastavniki_org/" class="footer__column-link" target="_blank" rel="noreferrer">instagram</a>
          </li>
          <li class="footer__column-links">
            <a href="https://www.youtube.com/user/Nastavniki/" class="footer__column-link" target="_blank" rel="noreferrer">youtube</a>
          </li>
        </ul>
      </div>
    </footer>
